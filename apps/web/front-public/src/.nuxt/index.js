...
import nuxt_plugin_plugin_118cd0e8 from 'nuxt_plugin_plugin_118cd0e8' // Source: ./components/plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_118cd0e8 === 'function') {
    await nuxt_plugin_plugin_118cd0e8(app.context, inject)
  }
